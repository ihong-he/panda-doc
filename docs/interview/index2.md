...
### 🔥 13、TypeScript 和 Javascript 的区别？

**核心区别：**

1. **类型系统** - JS是动态类型，变量可以随意赋值；TS是静态类型，编译时就能发现类型错误
2. **编译执行** - JS直接运行；TS需要编译成JS才能运行
3. **IDE支持** - TS有更好的代码提示、自动补全和重构能力
...
**一句话总结：**
TypeScript = JavaScript + 类型系统，是JS的超集，增强了代码的健壮性和开发体验。
